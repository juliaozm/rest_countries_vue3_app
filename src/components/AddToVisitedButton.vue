<template>
  <ButtonIcon
    v-if="uid"
    :icon="isLoading ? DotsCircleIcon : AirplanePlusIcon"
    :class="'tw-self-center tw-h-6 tw-w-6 tw-mr-3'"
    :disabled="isLoading"
    @click="addToTheList(uid, props.country, 'visitedCountries')"
  />
...
import { AirplanePlusIcon, DotsCircleIcon } from "mdi-vue3";
